...
export class MemoryWebView {
    ...
    public show(): void {
        ...
        this.panel = vscode.window.createWebviewPanel(
            'neuroforgeMemoryBrowser',
            'NeuroForge Memory Browser',
    ...
    public showSearchResults(query: string, results: MemoryContext[]): void {
        if (!this.panel) {
            this.show();
        }
    ...
    private async handleStoreMemory(content: any, tags: string[]): Promise<void> {
        try {
